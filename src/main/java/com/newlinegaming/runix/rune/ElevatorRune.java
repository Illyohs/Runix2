...
public class ElevatorRune extends PersistentRune {
    ...
    private WorldPos bottomLocation = null;
    ...
    public ElevatorRune(WorldPos coords, EntityPlayer activator){
     ...
     */
    protected void initializeRune(WorldPos coords) {
    ...
    protected void poke(EntityPlayer poker, WorldPos coords) {
        ...
        WorldPos destination = coords.offset(Vector3.facing[facing]).copyWithNewFacing(facing);
    ...
    public void bottomPoked(PlayerInteractEvent event)
    {
        ...
        {
            WorldPos punchBlock = new WorldPos(event.entity.worldObj, event.x, event.y, event.z);
