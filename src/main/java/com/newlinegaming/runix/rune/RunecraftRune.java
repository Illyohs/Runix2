...
import com.newlinegaming.runix.BaseTimedRune;
...
public class RunecraftRune extends BaseTimedRune {
    ...
    private HashSet<WorldPos> removeAirXYZ(HashSet<WorldPos> oldShapeCoords) {
        ...
        {
            WorldPos xyz = i.next(); //an iterator is necessary here because of ConcurrentModificationException
