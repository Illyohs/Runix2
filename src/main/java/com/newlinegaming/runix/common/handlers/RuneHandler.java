...
import com.newlinegaming.runix.common.rune.normal.CompassRune;
import com.newlinegaming.runix.common.rune.normal.OracleRune;
import com.newlinegaming.runix.common.rune.persistant.ElevatorRune;
import com.newlinegaming.runix.common.rune.persistant.FaithRune;
import com.newlinegaming.runix.common.rune.persistant.FerrousWheelRune;
import com.newlinegaming.runix.common.rune.persistant.FtpRune;
import com.newlinegaming.runix.common.rune.persistant.TeleporterRune;
...
import com.newlinegaming.runix.common.rune.timed.RunecraftRune;
import com.newlinegaming.runix.common.rune.timed.TorchBearerRune;
import com.newlinegaming.runix.common.rune.timed.ZeerixChestRune;
...
//                    ((PersistentRune) r).onPlayerLogin(((EntityPlayer)event.entity).getDisplayName());         
    ...
    public void possibleRuneActivationEvent(EntityPlayer player, WorldPos coords) {
        ...
        if (matchingRuneInfo != null) {
            ...
            UtilLog.info(player.getDisplayName() + " Has activated a " + matchingRune.getRuneName() + "");
