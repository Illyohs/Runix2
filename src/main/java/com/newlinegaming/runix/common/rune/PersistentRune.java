package com.newlinegaming.runix.common.rune;
...
import com.newlinegaming.runix.common.utils.UtilLog;
...
//			System.err.println("RUNIX: Couldn't write to file: " + fileName);
			UtilLog.warn("RUNIX: Couldn't write to file: " + fileName);
		} 
	}
	...
	public void loadRunes(Load loadEvent) {
		...
		try {
			...
			UtilLog.info("Runix: Can't access file or doesn't exist: " + fileName);
		} catch (Exception e){
//			System.err.println("GSON failed to parse " + fileName);
			UtilLog.fatal("GSON failed to parse " + fileName);
			e.printStackTrace();
		}
	}
