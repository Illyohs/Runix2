package com.newlinegaming.runix.client.utils;
...
public class RenderHelper {
    ...
    public boolean highlightBoxes(Collection<WorldPos> structureBlocks, boolean reverse, EntityPlayer player){
    	return highlightBoxes(structureBlocks, reverse, player,0, 216, 216);
    }
    public boolean highlightBoxes(Collection<WorldPos> structureBlocks, boolean reverse, EntityPlayer player,int R,int G, int B){
        ...
        GL11.glPushMatrix();
            ...
            for(WorldPos block : structureBlocks){
