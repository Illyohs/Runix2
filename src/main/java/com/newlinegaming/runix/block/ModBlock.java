...
public class ModBlock {
    ...
    public static Block     faithAnchor;
    ...
    public static void init() {
        ...
        faithAnchor = new FakeBlock(Blocks.gold_block);
    ...
    private static void Gamereg() {
        ...
        // GameRegistry.registerBlock(hoar_frost, HoarFrostItem.class,
        // "HoarFrost");
        // GameRegistry.registerBlock(runixAir, "Fake_Air");
        // GameRegistry.registerBlock(lightBeam, "RunixLightBeam");
        // GameRegistry.registerBlock(faithAnchor, "RunixFakeGoldBlock");
