...
//            {
//                WorldPos loc = new WorldPos(world, x,y,z);
//                for(WorldPos neighbor : loc.getNeighbors())
...
//    }
//
//    private void tryToCatchBlockOnFire(WorldPos loc, int lifespan)
//    {
...
//    }
//
//    private void spreadAndAgeFire(WorldPos loc, int lifespan, int parentX, int parentY, int parentZ) {
//        int newLifespan = lifespan + 1;//random.nextInt(6) / 2;
//
//        if (newLifespan > 15)
//            return; // we don't allow old fires to propagate more
//
//        loc.setBlockState(new SigBlock(this, newLifespan));//fire spreads to a new location
//    }
//
//    private int getFlammability(WorldPos loc) {
...
//        try {
//            return getFlammability(new WorldPos((World)world, x, y, z).offset(new Vector3(face)));
...
//    }
//
//    public static boolean consumeValuableForFuel(WorldPos coords, Block fuelBlock) {
